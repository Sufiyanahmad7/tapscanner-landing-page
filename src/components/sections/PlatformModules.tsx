...
const VISITOR_MANAGEMENT_FEATURES = [
  ...
  },
  {
    ...
    highlights: [
      ...
      'QR Code-Based Visitor Identification',
      'Visitor Badge Expiry Management',
    ],
    metrics: [
      { label: 'Badge Generation', value: '1.2 Sec' },
      { label: 'Digital Visitor Identification', value: '100%' },
    ],
  },
  {
    id: 'watchlist',
    ...
    metrics: [
      { label: 'Digital Visitor Verification', value: '100%' },
